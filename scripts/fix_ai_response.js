// Script to test and fix AI response parsing
    ...
    try {
        ...
        const response = await fetch(`${API_BASE_URL}/api/debug/test-ai`, {
            ...
            body: JSON.stringify({
                ...
                prompt: `你是一位经验丰富、富有爱心的小学班主任。请根据以下学生信息，撰写一段150字左右的期末评语。
...
async function main() {
    console.log('Starting AI prompt optimization test...');
