// Script to test and fix AI response parsing - Version 4
...
请根据以下学生信息，严格按照指定格式输出一段150-200字的期末评语：
...
输出要求：
1. 只输出一行文本，格式为：张乔俊一同学：[评语内容]
2. 不要输出任何其他内容，包括解释、思考过程等
3. 评语内容必须是150-200字
4. 语气温和、诚恳，多用鼓励性语言
...
async function main() {
    console.log('Starting AI prompt optimization test v4...');
