// Script to test and fix AI response parsing - Version 3
...
8. 直接输出以"张乔俊一同学："开头的完整评语内容，不要有任何前缀
9. 输出完成后立即停止，不要添加任何额外说明

输出格式：
张乔俊一同学：[完整的150-200字评语内容]`
            })
        });
...
async function main() {
    console.log('Starting AI prompt optimization test v3...');
