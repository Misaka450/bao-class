...
### 2025-01-29 - AI助教界面优化
- [x] 新增界面调整功能
  - 功能说明: AI助教聊天窗口支持用户自定义调整大小，并提供全屏显示功能
  - 实现功能:
    - 支持四角及边缘调整窗口大小
    - 添加全屏/退出全屏切换按钮
    - 最小尺寸限制（300×400像素）和最大尺寸限制
    - 流畅的动画过渡效果
  - 技术实现:
    - 使用React useState管理窗口尺寸和全屏状态
    - 实现鼠标拖拽调整大小功能（支持八个方向的边缘和角落）
    - 全屏模式下固定定位，覆盖层显示
    - 响应式设计，适配移动端显示
  - 文件变更:
    - frontend/src/components/AIChat/index.tsx（添加调整大小和全屏功能）
    - frontend/src/components/AIChat/style.css（添加调整手柄和全屏样式）
