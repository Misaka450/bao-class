...
// .wrangler/tmp/bundle-994yKz/strip-cf-connecting-ip-header.js
  ...
  "node_modules/bcrypt/bcrypt.js"(exports, module) {
    ...
    function genSalt(rounds, minor, cb) {
      ...
      crypto2.randomBytes(16, function(error4, randomBytes2) {
        ...
        bindings.gen_salt(minor, rounds, randomBytes2, cb);
      });
    }
    ...
    function compare2(data, hash4, cb) {
      let error3;
      if (typeof data === "function") {
      ...
      if (!cb) {
        return promises.promise(compare2, this, [data, hash4]);
      }
      if (data == null || hash4 == null) {
        error3 = new Error("data and hash arguments required");
        return process.nextTick(function() {
...
// .wrangler/tmp/bundle-994yKz/middleware-loader.entry.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// .wrangler/tmp/bundle-994yKz/middleware-insertion-facade.js
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
var generateToken = /* @__PURE__ */ __name(async (payload, secret) => {
  return await sign3(payload, secret);
}, "generateToken");
...
classes.post("/", async (c) => {
  ...
  if (!name || !grade)
    return c.json({ error: "Name and grade are required" }, 400);
...
students.post("/", async (c) => {
  ...
  if (!name || !student_id || !class_id)
    return c.json({ error: "Name, Student ID, and Class ID are required" }, 400);
  try {
    const { success } = await c.env.DB.prepare(
