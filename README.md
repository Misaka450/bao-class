...
### 🤖 AI 智能分析
- **智能评语生成** - 基于 Cloudflare Workers AI (Qwen3-30B) 自动生成个性化学生评语
- **班级学情报告** - AI 自动分析班级整体表现，生成深度分析报告
...
| **Cloudflare Workers AI** | - | 边缘计算 AI 推理（Qwen3-30B / Llama 3.2 Vision） |
...
│   │   │   └── stats/         # 统计分析模块
│   │   ├── services/          # 业务逻辑服务
│   │   │   └── analysis.service.ts  # 分析服务（含 AI 报告）
│   │   ├── middleware/        # 中间件
│   │   ├── schemas/           # Zod 验证模式
│   │   └── db/               # 数据库
│   │       ├── schema.sql     # 表结构
